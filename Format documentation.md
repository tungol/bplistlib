...
expresses the true size. I will refer to this value as the object length.
...
The object length is actually the value of the object, and the byte length 
is always zero. A value of 0 means null, 8 means False, and 9 means True. 
